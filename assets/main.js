...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#gallery02', { style: 'zoom-out', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container01', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('#container07', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.gallery.style1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('#container08', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('#container09', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('#container10', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
